...
A question about a UI topic is not automatically a visual question. "What does this feature mean in this context?" is conceptual — use the terminal. "Which wizard layout works better?" is visual — use the browser.
